package com.orengeHRM.actiondriver;
...
public class Action extends BaseClass {
	...
	public static void scrollByVisibility(WebDriver driver, WebElement ele) {
	...
	public static String getText(WebDriver driver, WebElement ele) {
	    ...
	    try {
	        ...
	        // Handle any potential exceptions (e.g., element not found)
	...
	public static String getTextbyAttribute(WebDriver driver, WebElement ele) {
	    String text = "";
	    try {
	        // Retrieve the text from the WebElement
